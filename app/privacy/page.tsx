        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-10 text-fg-muted text-[15px] md:text-base leading-relaxed">
            ...
            <Section title="8. Cookie-файлы и аналитика">
              <p>
                Сайт использует Яндекс.Метрику (счётчик № 110465032, оператор
                ООО «ЯНДЕКС», Россия) для сбора статистики посещений. В
                Метрике включены Вебвизор (запись действий пользователя на
                сайте), карта кликов и отслеживание переходов по ссылкам —
                это позволяет улучшать удобство сайта.
              </p>
              <p className="mt-3">
                Метрика загружается{" "}
                ...
                — при первом визите показывается баннер «Принять / Отклонить».
                Если пользователь отказался, счётчик не активируется, cookie
                не устанавливаются. Отозвать согласие можно, очистив хранилище
                сайта в настройках браузера.
              </p>
              <p className="mt-3">
                Собранные Метрикой данные обрабатываются в соответствии с{" "}
                <a
